...
module Examples
  module CustomTool
    ...
    # Custom tools create a class which responds to various callback methods
    # from SketchUp.
    class LineTool
      ...
      def activate
        ...
        # We make sure to call our utility method update_ui that updates
        # the statusbar with instructions on how to use the tool.
        update_ui
      end
